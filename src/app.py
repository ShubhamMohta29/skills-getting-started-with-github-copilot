...
activities = {
    ...
    "Basketball Club": {
        "description": "Basketball skills practice and pickup games",
    ...
    "Art Studio": {
        ...
        "max_participants": 16,
        "participants": ["jasper@mergington.edu", "lily@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, learn performance skills, and stage plays",
        "schedule": "Tuesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["maya@mergington.edu", "ryan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science challenges and build competition experiments",
